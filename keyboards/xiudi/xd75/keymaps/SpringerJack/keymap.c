...
enum layer_names { _DE, _SYM, _NN, _FN };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DE] = LAYOUT_ortho_5x15(
                            ...
                            KC_RBRC, KC_Q,    KC_W,  KC_E,    KC_R,    KC_T,   KC_VOLD,   KC_MUTE, KC_VOLU,    KC_Y,   KC_U,    KC_I,    KC_O,   KC_P,    KC_LBRC,
                            KC_CAPS, KC_A,    KC_S,  KC_D,    KC_F,    KC_G,   OSL(_FN),  FN,      C(KC_BSPC), KC_H,   KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT,
                            KC_LSFT, KC_Z,    KC_X,  KC_C,    KC_V,    KC_B,   KC_MPLY,   KC_MPRV, KC_MNXT,    KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                            KC_NO,   KC_LGUI, KC_NO, KC_LALT, MO(_NN), KC_SPC, KC_LCTL,   KC_LALT, KC_RCTL,    KC_ENT, MO(_NN), KC_LALT, KC_NO,  KC_LGUI, KC_NO),
  ...
  [_NN] = LAYOUT_ortho_5x15(
                            KC_F11,   KC_F1,   KC_F2,    KC_F3,   KC_F4,     KC_F5,    KC_TRNS, KC_TRNS, KC_NO,   KC_F6,   KC_F7, KC_F8,   KC_F9,   KC_F10,   KC_F12,
                            KC_NO,   KC_PGUP, KC_BSPC,  KC_UP,   KC_DELETE, KC_PGDN,  KC_TRNS, KC_TRNS, KC_NO,   KC_MAIL, KC_7,  KC_8,    KC_9,    KC_NO,   KC_MINS,
  ...
  /* I use mail because KC_PRSC does not produce PRINT with wayland */
